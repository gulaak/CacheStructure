...
################################################################
# This is a generated script based on design: Cache
#
...
if { $list_projs eq "" } {
   create_project project_1 myproj -part xcku035-fbva900-1L-i
}


# CHANGE DESIGN NAME HERE
variable design_name
set design_name Cache
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set Add [ create_bd_port -dir I -from 18 -to 0 Add ]
  ...
  connect_bd_net -net Add_1 [get_bd_ports Add] [get_bd_pins blk_mem_gen_0/addra]
  connect_bd_net -net CLK_1 [get_bd_ports CLK] [get_bd_pins blk_mem_gen_0/clka]
  connect_bd_net -net Din_1 [get_bd_ports Din] [get_bd_pins blk_mem_gen_0/dina]
  ...
  connect_bd_net -net blk_mem_gen_0_douta [get_bd_ports DOut] [get_bd_pins blk_mem_gen_0/douta]
