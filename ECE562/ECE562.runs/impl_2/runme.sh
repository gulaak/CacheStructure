...
HD_PWD='C:/Users/Aiden/Desktop/ECE562/ECE562.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log TopLevelCache.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TopLevelCache.tcl -notrace
